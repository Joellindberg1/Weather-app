...
export interface TimeSeries {
    validTime: string; //Datum och tid då prognosen gäller (ISO-format, t.ex. "2024-03-05T12:00:00Z")
...
export interface Parameter {
    ...
    values: number[]; //En array med numeriska värden för denna parameter
}
